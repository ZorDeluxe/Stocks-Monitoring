...
class ChartFrame(ctk.CTkFrame):
    ...
    def __init__(self, parent):
        ...
        self.place(x=0, y=0, relwidth=0.6, relheight=0.8)
    ...
    def Charts(self, stock: str='MSFT'):
        ...
        tabView.pack(padx=0, pady=0, side=tk.LEFT, fill=tk.BOTH, expand=True)
    ...
    def createChart(self, tab, stock: str='MSFT', period: str='1y') -> None:
        ...
        price.plot(kind='line', ax=ax, color='b', fontsize=8, grid=True, rot=90, ylabel='Stock Price ($)')
